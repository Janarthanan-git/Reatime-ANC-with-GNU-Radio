...
class ANC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.blk(mu=0.1, length=32)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Jana\\Downloads\\Refernce noise.wav', True)
        ...
        # Connections
        ##################################################
        self.connect((self.audio_source_0, 0), (self.epy_block_0, 1))
        self.connect((self.audio_source_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.audio_source_0, 0), (self.qtgui_time_sink_x_0, 1))
